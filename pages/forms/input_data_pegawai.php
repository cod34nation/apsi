                  ...
                  <div class="box-body">
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Tulis Kelurahan Anda"name ="kelurahan">
                    </div>
                    
                       <div class="form-group">
                      <label>Kecamatan  :</label>
                      <input type="text" class="form-control" placeholder="Tulis Kecamatan Anda" name="kecamatan">
                    </div>
