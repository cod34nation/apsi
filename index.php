    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Halaman ADMINISTRATOR PT AFF-SOFT
        ...
        <section class="content">
          <div class="callout callout-info">
            <h4>Perhatian</h4>
            <p>Ini adalah halaman administrator. Gunakan hak akses ini untuk menginputkan data baru pegawai dan update data pegawai(Pendataan)</p>
          </div>
